...
beforeAll(async() => {
    ...
    //Preenchendo as variaveis com dados em conformidade com as restrições da regra de negócio
...
describe('Entidade de Domínio da Categoria (Criar)',() => {
    ...
    //Recebe o nome do teste e uma função que contém as expectativas a serem testadas.
